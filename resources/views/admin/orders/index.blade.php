                                ...
                                @forelse ($orders as $order)
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <a class="btn button-main-db-sm custom-button-main-db-sm btn-primary btn-sm me-2"
                                            ...
                                            <form data-name="{{ $order->name }} {{ $order->surname }}"
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                <button class="button-danger-db-sm custom-button-danger-db-sm btn btn-danger btn-sm">
